...
public class Account {
     ...
     */
    public void addTimedPayment(String id, int interval, int next, Money amount, Bank tobank, String toaccount) {
    ...
    private class TimedPayment {
        ...
        TimedPayment(int interval, int next, Money amount, Account fromaccount, Bank tobank, String toaccount) {
        ...
        public boolean tick() {
            // fix interval taking one more tick than required
